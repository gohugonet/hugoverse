...
import (
	...
	"github.com/gohugonet/hugoverse/pkg/markup/highlight/chromalexers"
...
func (h chromaHighlighter) RenderCodeblock(cctx context.Context, w pio.FlexiWriter, ctx hooks.CodeblockContext) error {
	cfg := h.cfg
...
func highlight(fw pio.FlexiWriter, code, lang string, attributes []attributes.Attribute, cfg Config) (int, int, error) {
...
func writeDivStart(w pio.FlexiWriter, attrs []attributes.Attribute) {
