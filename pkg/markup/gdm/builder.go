...
import (
	"github.com/gohugonet/hugoverse/pkg/markup/gdm/images"
	"github.com/gohugonet/hugoverse/pkg/markup/gdm/internal/extensions/attributes"
	"github.com/gohugonet/hugoverse/pkg/markup/gdm/internal/extensions/codeblocks"
	"github.com/gohugonet/hugoverse/pkg/markup/gdm/internal/extensions/passthrough"
...
func NewBuilder(cfg Config) *Builder {
	return &Builder{
		...
		parserOptions:      []parser.Option{},
		extensions:         []goldmark.Extender{newLinks(cfg)},
	}
}
...
func (b *Builder) buildToc() {
	...
	b.extensions = append(b.extensions, newTocExtension(b.tocRendererOptions))
}

func (b *Builder) WithImage() {
	b.extensions = append(b.extensions, images.New(b.cfg.Parser.WrapStandAloneImageWithinParagraph))
}

func (b *Builder) WithCodeFences() {
	if b.cfg.Extensions.Highlight.CodeFences {
		b.extensions = append(b.extensions, codeblocks.New())
	}
}
...
func (b *Builder) WithPassThrough() {
	if b.cfg.Extensions.Passthrough.Enable {
		...
		b.extensions = append(b.extensions, passthrough.New(
			passthrough.Config{
...
func (b *Builder) WithAttributeBlock() {
	if b.cfg.Parser.Attribute.Block {
		b.extensions = append(b.extensions, attributes.New())
	}
}
...
func toTypographicPunctuationMap(t Typographer) map[extension.TypographicPunctuation][]byte {
