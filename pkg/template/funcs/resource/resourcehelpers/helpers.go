...
func ResolveIfFirstArgIsString(args []any) (resources.Resource, string, bool) {
	if len(args) != 2 {
		return nil, "", false
	}
...
func ResolveArgs(args []any) (resources.Resource, map[string]any, error) {
	...
	r, ok := args[1].(resources.Resource)
	if !ok {
