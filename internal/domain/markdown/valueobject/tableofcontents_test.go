...
var newTestTocBuilder = func() TocBuilder {
	var b TocBuilder
	b.AddAt(&TocHeading{Title: "Heading 1", ID: "h1-1"}, 0, 0)
	b.AddAt(&TocHeading{Title: "1-H2-1", ID: "1-h2-1"}, 0, 1)
	b.AddAt(&TocHeading{Title: "1-H2-2", ID: "1-h2-2"}, 0, 1)
	b.AddAt(&TocHeading{Title: "1-H3-1", ID: "1-h2-2"}, 0, 2)
	b.AddAt(&TocHeading{Title: "Heading 2", ID: "h1-2"}, 1, 0)
	return b
}
...
func TestToc(t *testing.T) {
	...
	toc.addAt(&TocHeading{Title: "Heading 1", ID: "h1-1"}, 0, 0)
	toc.addAt(&TocHeading{Title: "1-H2-1", ID: "1-h2-1"}, 0, 1)
	toc.addAt(&TocHeading{Title: "1-H2-2", ID: "1-h2-2"}, 0, 1)
	toc.addAt(&TocHeading{Title: "1-H3-1", ID: "1-h2-2"}, 0, 2)
	toc.addAt(&TocHeading{Title: "Heading 2", ID: "h1-2"}, 1, 0)
...
func TestTocMissingParent(t *testing.T) {
	...
	toc.addAt(&TocHeading{Title: "H2", ID: "h2"}, 0, 1)
	toc.addAt(&TocHeading{Title: "H3", ID: "h3"}, 1, 2)
	toc.addAt(&TocHeading{Title: "H3", ID: "h3"}, 1, 2)
